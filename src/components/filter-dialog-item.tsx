...
interface FilterDialogItemProps {
  ...
  onOperatorChange: (filterIndex: number, selectedOperatorValue: string) => void;
  onPropertyChange: (filterIndex: number, selectedPropertyName: string) => void;
  onRemoveFilter: (index: number) => void;
  onValueChange: (filterIndex: number, value: Date | string) => void;
      ...
      >
        ...
        >
          ...
          >
            {operators
              .filter((operator) => (
                operator.typesAccepted.includes(filter.property.type)
